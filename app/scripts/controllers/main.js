...
angular.module('pancakeApp')
  .controller('MainCtrl', function ($scope) {
    ...
    $scope.keywordList = [
      {icon: 'fa fa-bullhorn fa-3x', name: '재미짐', description: '정말로 쉽고 재미있는 MIDI 작곡'},
      {icon: 'fa fa-coffee fa-3x', name: '쉬움', description: '쉽고 빠른 MIDI 공유'},
      {icon: 'fa fa-headphones fa-3x', name: '감상', description: '무한 MIDI 플레이~'}
    ];
