    ...
    $scope.playerlists = [
      {
        ...
        publisher: 'bruno mars lover', publisher_profile_image: 'Some Image...',
        music_list: [
          { name: 'Marry You', time: 240, album: 'Doo-Wops & Hooligans', url: 'some url..' },
          { name: 'Money Make Her Smile', time: 180, album: 'Unorthodox Jukebox', url: 'some url..' }
        ]
      },
      {
        id: 2,
        ...
        music_list: [
          { name: 'Why So Serious?', time: 554, album: 'Dark Knights O.S.T', url: 'some url..' },
          { name: 'Like A Dog Chasing Cars', time: 303, album: 'Dark Knights O.S.T', url: 'some url..' }
        ]
      }
    ];
